...
describe("Category Integration Tests", () => {
    describe("create method", () => {
        ...
        it("should a valid category", () => {
            expect.assertions(0);
            new category_1.Category({ name: "Movie" }); // NOSONAR
            new category_1.Category({ name: "Movie", description: "some description" }); // NOSONAR
            new category_1.Category({ name: "Movie", description: null }); // NOSONAR
            /* NOSONAR */ new category_1.Category({
                name: "Movie",
