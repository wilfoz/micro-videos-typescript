...
describe('InMemorySearchableRepository Tests Units', () => {
    ...
    it("should apply paginate and sort", async () => {
        ...
        const arrange = [
            {
                params: new repository_contracts_1.SearchParams({ page: 1, per_page: 2, sort: 'name', sort_dir: 'asc' }),
            ...
            {
                params: new repository_contracts_1.SearchParams({ page: 2, per_page: 2, sort: 'name', sort_dir: 'asc' }),
                result: new repository_contracts_1.SearchResult({
